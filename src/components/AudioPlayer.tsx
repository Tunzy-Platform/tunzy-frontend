...
export function AudioPlayer({
  ...
  return (
    <div className="w-full h-full min-h-10 md:min-h-20 rounded-2xl overflow-hidden backdrop-blur-3xl relative font-sans">
      ...
      {isMobile && (
        <div
          className="relative z-10 h-full flex-col md:flex-row md:items-center md:px-5 md:gap-3"
      ...
      {!isMobile && (
        <div
          className=" relative z-10 h-full flex md:flex-row md:items-center md:px-5 md:gap-3"
          style={{ opacity: isDragging ? 0.4 : 1, transition: "opacity 0.3s" }}
        >
